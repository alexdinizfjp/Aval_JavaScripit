...
console.log("=== EXIBIÇÃO DO RELATÓRIO FINAL (Utilizando for...of) ===");

for (const aluno of relatorioAlunos) {

  console.log(
    `Discente: ${aluno.nome.padEnd(10, ' ')} | Média: ${aluno.media.toFixed(2)} | Situação: ${aluno.situacao}`
  );
}